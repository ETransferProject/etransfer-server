...
public class TokenPoolState
{
    ...
    [Id(5)] public Dictionary<string, string> WithdrawFeeInfo { get; set; } = new();
    [Id(6)] public Dictionary<string, string> Pool { get; set; } = new();
    [Id(7)] public Dictionary<string, string> DepositFeeInfo { get; set; } = new();
    [Id(8)] public Dictionary<string, string> ThirdPoolFeeInfo { get; set; } = new();
}