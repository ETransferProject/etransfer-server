...
using ETransferServer.SignatureServer.Controllers;
using ETransferServer.SignatureServer.Options;
using ETransferServer.SignatureServer.Providers;
using Volo.Abp;
...
namespace ETransferServer.SignatureServer
{
    ...
    public class ETransferServerSignatureApiHostModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            var assembly = typeof(ETransferServerSignatureApiHostModule).Assembly;
        ...
        private void ConfigureConventionalControllers()
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(ETransferServerSignatureApiHostModule).Assembly);
