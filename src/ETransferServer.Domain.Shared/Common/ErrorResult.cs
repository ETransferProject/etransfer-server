...
public static class ErrorResult
{
    ...
    public static readonly Dictionary<int, string> ResponseMappings = new()
    {
        ...
        { 40004, "{token_symbol} is not supported on the current network. Please check and ensure you provide the right token symbol." },
        ...
        { 40009, "Invalid transfer amount. Please check and ensure you enter the right amount (should be greater than the transaction fee)." },
        { 40012, "Invalid transfer amount. The ETransfer team is actively looking into this issue. Please be assured that your accounts and assets will remain unaffected." },
        { 40013, "The remaining transfer quota for today is insufficient, with {amount} available. Please try again after {number} hours or consider transferring a smaller amount." },
        ...
        { 40101, "If you're transferring to {Networks}, please wait a while for the service to be restored and try again later." },
